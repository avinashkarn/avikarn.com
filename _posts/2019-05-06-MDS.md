...
<hr>
<img src="/image/mds/tassel2.gif" alt="Calculate distance matrix">

<h2> Step: 3 Calculate MDS</h2>

<hr>
<img src="/image/mds/tassel3.gif" alt="Calculate MDS">

<h2> Step: 4 Plot PCoAs in TASSEL</h2>

<hr>
<img src="/image/mds/tassel4.gif" alt="Plot MDS">

<h2> Optional step: Plotting in R using GGplot </h2>
One may plot the PCoA results in R using the below commands:
